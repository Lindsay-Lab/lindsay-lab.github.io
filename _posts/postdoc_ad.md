...
The ideal candidate will have a PhD in Psychology, Neuroscience, Computer Science, or a related field. They will have a demonstrated interest in the study of sensory processing and/or attention and will have worked with and understand the architectures of various VLMs. Exceptional candidates without a PhD will be considered if they have equivalent research experience. 

To express interest, send an email to <grace.lindsay@nyu.edu> (subject line “VLM Postdoc Position”) with your CV and a research statement (~2 pages) describing the style of work you would like to do at this intersection and how your past work prepares you for this.
This position is funded through support from [Longview Philanthropy](https://www.longview.org/) and will have a salary of ~72,000 USD. 
