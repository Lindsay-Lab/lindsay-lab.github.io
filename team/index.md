...
{%
  ...
  **Update**: The Lab is hiring a postdoc. If you'd like to work on a research project that fits into either of the first two research areas [here](https://lindsay-lab.github.io/research/) then send a CV, half page project proposal & contact info for 3 references to grace.lindsay@nyu.edu with subject "Postdoc Application""
%}
